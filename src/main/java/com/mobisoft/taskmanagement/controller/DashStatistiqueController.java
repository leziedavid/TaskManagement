...
public class DashStatistiqueController {
    ...
    public ResponseEntity<BaseResponse<GlobalStatsDTO>> getProjetStats(@RequestHeader("Authorization") String authorizationHeader) {
        try {
            // Extrait le token JWT en enlevant le préfixe "Bearer "
            ...
            GlobalStatsDTO stats = dashStatisticsService.getProjectStatistics(token);
